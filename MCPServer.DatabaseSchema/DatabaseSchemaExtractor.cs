...
public class DatabaseSchemaExtractor
{
    ...
    private async Task<List<dynamic>> ExtractTablesAsync(string databaseName)
    {
        ...
        while (await reader.ReadAsync())
        {
            tables.Add(new
            {
                id = $"{reader["schema_name"].ToString().ToLower()}.{reader["name"].ToString().ToLower()}",
                schemaId = reader["schema_name"].ToString().ToLower(),
                name = reader["name"].ToString(),
    ...
    private async Task<List<dynamic>> ExtractColumnsAsync(string databaseName)
    {
        ...
        while (await reader.ReadAsync())
        {
            string tableId = $"{reader["schema_name"].ToString().ToLower()}.{reader["table_name"].ToString().ToLower()}";
            
            columns.Add(new
            {
                id = $"{tableId}.{reader["name"].ToString().ToLower()}",
                tableId = tableId,
                name = reader["name"].ToString(),
    ...
    private async Task<List<dynamic>> ExtractPrimaryKeysAsync(string databaseName)
    {
        ...
        while (await reader.ReadAsync())
        {
            ...
            var columnId = $"{tableId}.{reader["column_name"].ToString().ToLower()}";
    ...
    private async Task<List<dynamic>> ExtractForeignKeysAsync(string databaseName)
    {
        ...
        {
            string tableId = $"{reader["schema_name"].ToString().ToLower()}.{reader["table_name"].ToString().ToLower()}";
            string referencedTableId = $"{reader["referenced_schema_name"].ToString().ToLower()}.{reader["referenced_table_name"].ToString().ToLower()}";
            ...
            var columnId = $"{tableId}.{reader["column_name"].ToString().ToLower()}";
            var referencedColumnId = $"{referencedTableId}.{reader["referenced_column_name"].ToString().ToLower()}";
    ...
    private string GetReferentialActionName(int actionId)
    {
